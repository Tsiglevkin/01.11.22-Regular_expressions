...
### Заметка.
в функции merge_doubles сделана проверка на длину строки, т.к. одна из записей имеет длину 8 вместо 7 у всех остальных. Делать проверку по длине строки заголовков не стал.